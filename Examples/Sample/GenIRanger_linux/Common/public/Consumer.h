...
public:
  ...
  */
  GenTL::IF_HANDLE openInterfaceById(const InterfaceId& interfaceId);
  ...
  */
  ...
  InterfaceList getInterfaces(GenTL::TL_HANDLE hTL);
    ...
    /** Returns a list of available interfaces. */
    InterfaceList getInterfaces_is_changed(GenTL::TL_HANDLE hTL, bool & changed);
  ...
  */
  ...
  DeviceList getDevices(GenTL::IF_HANDLE ifHandle);
    ...
    DeviceList getDevices_is_changed(GenTL::IF_HANDLE ifHandle);
