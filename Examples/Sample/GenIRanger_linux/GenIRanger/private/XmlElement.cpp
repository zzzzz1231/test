...
GenIRanger::XmlElement& XmlElement::addChild(const XmlElement& child)
{
  // Cannot have both text and child elements
  assert(mText.empty());
...
const std::string& XmlElement::attribute(const std::string& name)
{
...
GenIRanger::XmlElement& XmlElement::attribute(const std::string& name,
...
const std::vector<GenIRanger::XmlElement>& XmlElement::children() const
{
  return mChildren;
}
...
GenIRanger::XmlElement xml(const std::string& name)
{
