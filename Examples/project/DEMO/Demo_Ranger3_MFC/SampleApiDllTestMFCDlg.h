...
public:
	...
	RangeAxis	get_RangeAxis	()	const	{ return m_pImg->getR_RangeAxis	();}
...
public:
	...
	std::map<CString, PTR<ImageGrabber>>	m_Name_Ranger3s;
...
protected:
	...
	void	_showMatImgToWnd		(CWnd * pictureWnd, const cv::Mat & disimg);
